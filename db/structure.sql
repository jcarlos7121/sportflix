...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE,
 "UPDATED_AT" DATE,
 CONSTRAINT SYS_C008756 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "NAME" VARCHAR2(255),
 CONSTRAINT SYS_C008750 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C008766 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 CONSTRAINT SYS_C008720 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE NOT NULL,
 "UPDATED_AT" DATE NOT NULL,
 CONSTRAINT SYS_C008738 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE NOT NULL,
 "UPDATED_AT" DATE NOT NULL,
 CONSTRAINT SYS_C008761 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE NOT NULL,
 "UPDATED_AT" DATE NOT NULL,
 CONSTRAINT SYS_C008771 PRIMARY KEY (ID)
)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "CREATED_AT" DATE NOT NULL,
 "UPDATED_AT" DATE NOT NULL,
 CONSTRAINT SYS_C008733 PRIMARY KEY (ID)
)
...
CREATE UNIQUE INDEX "I_USER_EVENTS_USER_ID_EVENT_ID" ON "USER_EVENTS" ("USER_ID", "EVENT_ID")

/

ALTER TABLE USER_EVENTS ADD CONSTRAINT I_USER_EVENTS_USER_ID_EVENT_ID UNIQUE (USER_ID,EVENT_ID)
...
"ID" NUMBER(38,0) NOT NULL,
 ...
 "UPDATED_AT" DATE NOT NULL,
 "NAME" VARCHAR2(255),
 CONSTRAINT SYS_C008727 PRIMARY KEY (ID)
)
...
INSERT INTO schema_migrations (version) VALUES ('20160513181741')

/

INSERT INTO schema_migrations (version) VALUES ('20160513183642')

/

INSERT INTO schema_migrations (version) VALUES ('20160513190318')

/

INSERT INTO schema_migrations (version) VALUES ('20160513194005')
